...
public class BasicAuthSecuredContext implements HttpContext {
	...
	public BasicAuthSecuredContext(URL resourceBase, URL configFile,
		...
		logger.info("ICE Vaadin UI Message: Resource URL = " + resourceBase.getPath());
		logger.info("ICE Vaadin UI Message: Authentication config " + "file URL = "
				+ configFile.getPath());
	...
	private boolean failAuthorization(HttpServletRequest request,
		...
		logger.info("ICE Vaadin UI Message: Basic Authentication failed!");
