...
\cite{linkedDataLOV}. These schemas can be included through an approriate import
...
Good tooling is absolultely critical for successful deployment of ontological
methods. \ldots
